...
import {
  LayoutDashboard, Users, FileText, BookOpen, Bot, Settings, LogOut,
  ChevronLeft, ChevronRight, Sun, Moon, GraduationCap, Car, BarChart3,
  Bell, ClipboardList, Menu, X
} from "lucide-react";
...
const studentLinks = [
  ...
  { to: "/student/errors", icon: Bell, label: "Xatolar" },
  { to: "/student/results", icon: BarChart3, label: "Natijalar" },
];

export default function DashboardSidebar() {
  const { role, userName, logout, theme, toggleTheme } = useAuth();
